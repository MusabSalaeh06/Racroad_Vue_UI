<template>
            ...
            <li>
                <ul v-if=" tab == 1 ">
                    <button @click="activeTabOne"
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">ดูข้อมูลรถยนต์</span>
                    </button>
                </ul>
                <ul v-else>
                    <button @click="activeTabOne"
                        ...
                        <span class="ml-3">ดูข้อมูลรถยนต์</span>
                    </button>
                </ul>
            </li>
            <li>
                <ul v-if=" tab == 2 ">
                    <button @click="activeTabTwo"
                        class="flex items-center p-2 text-2xl font-bold text-gray-900 rounded-lg text-white bg-blue-700 hover:text-white dark:hover:bg-gray-700">
                        <span class="ml-3">เพิ่มข้อมูลรถยนต์</span>
                    </button>
                </ul>
                <ul v-else>
                    <button @click="activeTabTwo"
    ...
    <div v-show="tab === 1">
        ...
        <div class="grid bg-white p-1 shadow-md rounded-md gap-6 mb-3 md:grid-cols-2 xl:grid-cols-5">
            <label class="block text-2xl">
            ...
            <table class="w-full text-xl text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody class="text-2xl ">
                    <tr class="bg-gray-50 border-b dark:bg-gray-800 dark:border-gray-700"
                        ...
                        <router-link :to="'/Car-Edit/'+item.car_id" class="nav-link">
                            <button type="button"
    ...
    methods: {
        ...
        AddCarData(e) {
            ...
            upload.append('brand', this.brand),
                ...
                axios.post('http://racroad-api.test/api/car/store', upload).then((response) => {
                        ...
                        this.subversion = '';
                        this.fuel = '';
                        if (this.message == "ข้อมูลที่ป้อนซ้ำ") {
                        Swal.fire(
                            'ข้อมูลที่ป้อนซ้ำ! กรุณากรอกข้อมูลใหม่',
                        ) 
                        }
                        else{
                        Swal.fire(
